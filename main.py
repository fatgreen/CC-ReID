...
from models import build_model50, build_model101, build_model152
...
def main(config):
    ...
    # Build model
    model, model2, fuse, classifier, clothes_classifier, clothes_classifier2 = build_model152(config, dataset.num_train_pids, dataset.num_train_clothes)
    print("model loaded")
